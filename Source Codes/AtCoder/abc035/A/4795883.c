main(a,b){scanf("%d%d",&a,&b);puts(a%16+(b%9)?"4:3":"16:9");} ./Main.c:1:1: warning: return type defaults to ‘int’ [-Wimplicit-int]
 main(a,b){scanf("%d%d",&a,&b);puts(a%16+(b%9)?"4:3":"16:9");}
 ^
