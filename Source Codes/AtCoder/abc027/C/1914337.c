...
./Main.c:452:8: warning: format ‘%llu’ expects argument of type ‘long long unsigned int *’, but argument 2 has type ‘ull * {aka long unsigned int *}’ [-Wformat=]
  scanf("%llu", &n, &k);
        ^
./Main.c:452:8: warning: too many arguments for format [-Wformat-extra-args]
./Main.c:452:2: warning: ignoring return value of ‘scanf’, declared with attribute warn_unused_result [-Wunused-result]
  scanf("%llu", &n, &k);
  ^