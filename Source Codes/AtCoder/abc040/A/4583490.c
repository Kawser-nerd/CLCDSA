main(a,b){scanf("%d%d",&a,&b);printf("%g",fmin(b-1,a-b));} ./Main.c:1:1: warning: return type defaults to ‘int’ [-Wimplicit-int]
 main(a,b){scanf("%d%d",&a,&b);printf("%g",fmin(b-1,a-b));}
 ^
