...
./Main.c:424:10: warning: format ‘%llu’ expects argument of type ‘long long unsigned int’, but argument 2 has type ‘ull {aka long unsigned int}’ [-Wformat=]
   printf("%llu\n", dp[(n + i - sum) % n]);
          ^
...
./Main.c:452:8: warning: format ‘%llu’ expects argume...