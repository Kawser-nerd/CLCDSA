...
class Program
{
    static void Main()
    {
        ...
        int[] len = Console.ReadLine().Split().Select(i => int.Parse(i)).ToArray();
        ...
        */
        Console.WriteLine(len.Sum()>=input[3]? input[0] * len[0] + input[1] * len[1]-len.Sum()*input[2]:input[0]*len[0]+input[1]*len[1]);
