...
namespace Practice
{
    class Program
    {
        ...
        private class Info
        {
            ...
            public long price;
            public long perf;
            public Info(long L, long price, long perf)
            {
                this.L = L;
                this.price = price;
                this.perf = perf;
        ...
        static void Solve()
        {
            ...
            var s = o[2];
            var d = o[3];
            var n = ReadAndParseLong() * 4;


            var list = new List<Info>();
            list.Add(new Info(8, d, d));
            list.Add(new Info(4, s, 2*s));
            list.Add(new Info(2, h, 4*h));
            list.Add(new Info(1, q, 8*q));
            list.Sort((a, b) => a.perf.CompareTo(b.perf));
