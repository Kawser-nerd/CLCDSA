...
./Main.c:308:8: warning: format ‘%lld’ expects argument of type ‘long long int *’, but argument 2 has type ‘sll * {aka long int *}’ [-Wformat=]
  scanf("%lld%lld%lld", &a, &b, &c);
        ^
./Main.c:308:8: warning: format ‘%lld’ expects argument of type ‘long long int *’, but argument 3 has type ‘sll * {aka long int *}’ [-Wformat=]
./Main.c:308:8: warning: format ‘%lld’ expects argument of type ‘long long int *’, but argument 4 has type ‘sll * {aka long int *}’ [-Wformat=]
./Main.c:319:9: warning: format ‘%llu’ expects argument of type ‘long long unsigned int’, b...