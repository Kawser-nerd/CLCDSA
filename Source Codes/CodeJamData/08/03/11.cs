...
class Program {
    ...
    static void Main(string[] args) {
        ...
        //    var o2 = new TrainTimetable();
        //    string s2 = Console.ReadLine();
        //    int T = int.Parse(s2);
        //    s2 = Console.ReadLine();
        //    int A = int.Parse(s2.Split(' ')[0]);
        //    int B = int.Parse(s2.Split(' ')[1]);
        //    string[] ATrips = new string[A];
        //    string[] BTrips = new string[B];
        //    for (int j = 0; j < A; j++) {
        //        ATrips[j] = Console.ReadLine();
        //    }
        //    for (int j = 0; j < B; j++) {
        //        BTrips[j] = Console.ReadLine();
        //    }
        //    string s3 = o2.Process2(T,ATrips,BTrips);
        //    Console.WriteLine("Case #{0}: {1}", i + 1, s3);
        //}
        ...
        for (int i = 0; i < N; i++) {
            ...
            var o2 = new FlySwatter();
            string s2 = Console.ReadLine();
            string s3 = o2.Process(s2);
            Console.WriteLine("Case #{0}: {1}", i + 1, s3);
        }
