...
./Main.c:331:8: warning: too many arguments for format [-Wformat-extra-args]
  scanf("%llu", &n, &m);
        ^
./Main.c:337:9: warning: too many arguments for format [-Wformat-extra-args]
   scanf("%llu", &a[i], &b[i]);
         ^
./Main.c:331:2: warning: ignoring return value of ‘scanf’, declared with attribute warn_unused_result [-Wunused-result]
  scanf("%llu", &n, &m);
  ^
./Main.c:337:3: warning: ignoring return value of ‘scanf’, declared with attribute warn_unused_result [-Wunused-result]
   scanf("%llu", &a[i], &b[i]);
   ^