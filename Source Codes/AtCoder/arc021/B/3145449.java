...
public class Main {
    ...
    public static boolean xorDiff(boolean a, boolean b) {
        return a != b;
    }

    public static long xorDiff(long a, long b) {
        long sum = 0;
        for (int i = 63; i >= 0; i--) {
            sum *= 2;
            if (xorDiff(bget(a, i), bget(b, i))) sum++;
        }
        return sum;
    }
