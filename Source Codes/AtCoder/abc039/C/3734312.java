...
public class Main {
    public static void main(String[] args) {
        ...
        int index=string.indexOf("WWBWBWW");
        String[] onkai={"Do","Do#","Re","Re#","Mi","Fa","Fa#","So","So#","La","La#","Si"};
        List<String> onkaiList=Arrays.asList(onkai);
        Collections.reverse(onkaiList);
        put(onkaiList.get((index)%12));
