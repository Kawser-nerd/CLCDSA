...
./Main.c:438:10: warning: format ‘%llu’ expects argument of type ‘long long unsigned int’, but argument 2 has type ‘ull {aka long unsigned int}’ [-Wformat=]
   printf("%llu%c", a[i], (i == n - 1 ? '\n' : ' '));
          ^
./Main.c: In function ‘main’:
./Main.c:474:8: warning: format ‘%llu’ expects argument of type ‘long long unsigned int *’, but argument 2 has type ‘ull * {aka long unsigned int *}’ [-Wformat=]
  scanf("%llu", &n, &m);
        ^
./Main.c:474:8: warning: too many arguments for format [-Wformat-extra-args]
./Main.c:476:8: warning: format ‘%llu’ exp...