...
namespace CodeJam
{
    class GCJIO
    {
        ...
        public double nextLineAsDouble()
        {
            return double.Parse(nextLine());
        }
        ...
        public double[] nextLineSeparatedAsDouble()
        {
            return nextLineSeparated().Select(t => double.Parse(t)).ToArray();
        }
    }
    ...
    class GCJ
    {
        ...
        {
            init("2017r2", "A");
            IProblemSolver solution = new _2017r2.ProblemA();
