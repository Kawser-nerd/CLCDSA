...
./Main.c:431:8: warning: format ‘%llu’ expects argument of type ‘long long unsigned int *’, but argument 2 has type ‘ull * {aka long unsigned int *}’ [-Wformat=]
  scanf("%llu", &n, &m);
        ^
./Main.c:431:8: warning: too many arguments for format [-Wformat-extra-args]
./Main.c:432:8: warning: format ‘%llu’ expects argument of type ‘long long unsigned int *’, but argument 2 has type ‘ull * {aka long unsigned int *}’ [-Wformat=]
  scanf("%llu", &k, &n, &m);
        ^
./Main.c:432:8: warning: too many arguments for format [-Wformat-extra-args]
./Main.c:452:9: warning: format ‘%lld’ expects argument of type ‘long long int *’, but argument 2 has type ‘sll * {aka long int *}’ [-Wformat=]
   scanf("%lld", &a[i]);
         ^
./Main.c:453:9: warning: format ‘%lld’ expects arg...