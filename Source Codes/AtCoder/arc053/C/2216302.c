...
./Main.c:417:9: warning: format ‘%llu’ expects argument of type ‘long long unsigned int’, but argument 2 has type ‘sll {aka long int}’ [-Wformat=]
  printf("%llu\n", result);
         ^
...
./Main.c:459:9: warning: format ‘%llu’ expects argument of type ‘long long unsi...