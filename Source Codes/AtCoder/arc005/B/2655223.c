...
./Main.c:330:8: warning: format ‘%llu’ expects argument of type ‘long long unsigned int *’, but argument 2 has type ‘sll * {aka long int *}’ [-Wformat=]
  scanf("%llu%llu %s", &w, &h, op);
        ^
./Main.c:330:8: warning: format ‘%llu’ expects argument of type ‘long long unsigned int *’, but argument 3 has type ‘sll * {aka long int *}’ [-Wformat=]
./Main.c:330:2: warning: ignoring return value of ‘scanf’, declared with attribute warn_unused_result [-Wunused-result]
  scanf("%llu%llu %s", &w, &h, op);
  ^
./Main.c:353:3: warning: ignoring return value of ‘scanf’...