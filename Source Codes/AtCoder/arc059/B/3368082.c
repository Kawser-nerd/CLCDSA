...
./Main.c:1:35: warning: implicit declaration of function ‘getchar_unlocked’ [-Wimplicit-function-declaration]
 i,b;main(a,c){for(;c-b&&c-a&&~c;c=getchar_unlocked(i++))a=b,b=c;printf("...