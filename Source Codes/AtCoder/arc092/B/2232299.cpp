  ...
  REP(ii,BSZ){
    ...
    REP(jj,BSZ){
      REP(i,eee){
        ...
        while(it != end){
          __m128i b1, b2, b3, b4;
          b1 = _mm_load_si128(it++);
          b2 = _mm_load_si128(it++);
          b3 = _mm_load_si128(it++);
          b4 = _mm_load_si128(it++);
          b1 = _mm_add_epi32(b1, aaaa);
          b2 = _mm_add_epi32(b2, aaaa);
          b3 = _mm_add_epi32(b3, aaaa);
          b4 = _mm_add_epi32(b4, aaaa);
          xors = _mm_xor_si128(xors, b1);
          xors = _mm_xor_si128(xors, b2);
          xors = _mm_xor_si128(xors, b3);
          xors = _mm_xor_si128(xors, b4);
          b1 = _mm_load_si128(it++);
          b2 = _mm_load_si128(it++);
          b3 = _mm_load_si128(it++);
          b4 = _mm_load_si128(it++);
