...
./Main.c:528:9: warning: format ‘%llu’ expects argument of type ‘long long unsigned int’, but argument 2 has type ‘ull {aka long unsigned int}’ [-Wformat=]
  printf("%llu\n", result);
         ^
./Main.c: In function ‘main’:
./Main.c:559:8: warning: format ‘%llu’ expects argument of type ‘long long unsigned int *’, but argument 2 has type ‘ull * {aka long unsigned int *}’ [-Wformat=]
  scanf("%llu", &n, &k);
        ^
./Main.c:559:8: warning: too many arguments for format [-Wformat-extra-args]
./Main.c:579:10: warning: format ‘%llu’ expects argument of type ‘long...