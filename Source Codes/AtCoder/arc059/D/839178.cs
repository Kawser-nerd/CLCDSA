...
public partial struct ModInteger
{
    ...
    public static ModInteger operator +(ModInteger l, ModInteger r) { var n = new ModInteger() { num = l.num + r.num }; if (n.num >= Mod) n.num -= Mod; return n; }
    public static ModInteger operator -(ModInteger l, ModInteger r) { var n = new ModInteger() { num = l.num + Mod - r.num }; if (n.num >= Mod) n -= Mod; return n; }
