main(n){scanf("%d",&n);puts(n>17|19890%n|n==15?"Yes":"No");} ./Main.c:1:1: warning: return type defaults to ‘int’ [-Wimplicit-int]
 main(n){scanf("%d",&n);puts(n>17|19890%n|n==15?"Yes":"No");}
 ^
