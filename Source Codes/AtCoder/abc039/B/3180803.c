main(n){scanf("%d",&n);printf("%.f",pow(n,.25));} ./Main.c:1:1: warning: return type defaults to ‘int’ [-Wimplicit-int]
 main(n){scanf("%d",&n);printf("%.f",pow(n,.25));}
 ^
...
./Main.c:1:37: warning: implicit declaration of function ‘pow’ [-Wimplicit-function-declaration]
 main(n){scanf("%d",&n);printf("%.f",p...