...
./Main.c:530:8: warning: format ‘%lld’ expects argument of type ‘long long int *’, but argument 2 has type ‘sll * {aka long int *}’ [-Wformat=]
  scanf("%lld", &vsa, &vsb, &vsc);
        ^
./Main.c:530:8: warning: too many arguments for format [-Wformat-extra-args]
./Main.c:530:2: warning: ignoring return value of ‘scanf’, declared with attribute warn_unused_result [-Wunused-result]
  scanf("%lld", &vsa, &vsb, &vsc);
  ^