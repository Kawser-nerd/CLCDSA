...
static class Func
{
	public static Tree ConstructTree(this IList<int> list) => list.ConstructTree(0, list.Count);
	...
	public static long Sum(this Tree t) => t == null ? 0 : t.Sum;
	public static Tree Add(this Tree t, long lz) => t == null || lz == 0 ? t : new Tree(t.L, t.V, t.R, t.Sum + t.C * lz, t.Lazy + lz, t.H, t.C);
	public static Tree Update(this Tree t) => t == null || t.Lazy == 0 ? t : new Tree(t.L.Add(t.Lazy), t.V + t.Lazy, t.R.Add(t.Lazy), t.Sum, 0, t.H, t.C);
