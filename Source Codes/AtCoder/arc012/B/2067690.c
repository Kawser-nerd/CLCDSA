...
./Main.c:390:8: warning: format ‘%llu’ expects argument of type ‘long long unsigned int *’, but argument 2 has type ‘ull * {aka long unsigned int *}’ [-Wformat=]
  scanf("%llu%llu", &vua, &vub, &vuc, &vud, &vue, &vuf);
        ^
./Main.c:390:8: warning: format ‘%llu’ expects argument of type ‘lo...