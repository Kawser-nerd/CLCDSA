...
public class Hello
{
    ...
    public static void Main()
    {
        ...
        if (xy.Contains(0))
        {
            if (x == 0)
            {
                if (y < 0) Console.WriteLine((y*-1) + 1);
        ...
        else if (Math.Abs(x) == Math.Abs(y)) Console.WriteLine(1);
        else if (x < 0 && y < 0)
        {
            if (x < y) Console.WriteLine(Math.Abs(y - x));
            else if (y < x) Console.WriteLine(Math.Abs(y - x) + 2);
        }
        else if (x < 0 && 0 < y)
        {
            x *= -1;
            if (x < y) Console.WriteLine(Math.Abs(y - x) + 1);
            else if (y < x) Console.WriteLine(Math.Abs(y - x) + 1);
        }
        else if (0 < x && y < 0)
        {
            x *= -1;
