...
./Main.c:62:8: warning: format ‘%s’ expects argument of type ‘char *’, but argument 2 has type ‘char (*)[27]’ [-Wformat=]
  scanf("%s", &S);
        ^
...
./Main.c:37:23: warning: ignoring return value of ‘scanf’, declared with attribute war...