    ...
    class Program
    {
        ...
        static void Solve()
        {
            ...
            for(int i=0;i<n;++i)
            {
                ...
                {
                    if( i == j) { continue; }
                    int aokiScore = CalcAokiScore(a, i, j);
                    if(aokiScore > max)
                    {
                        max = aokiScore;
                        idx = j;
                ...
                int takahashiScore = CalcTakahashiScore(a, i, idx);
                ans = Math.Max(ans, takahashiScore);
            }
            Console.WriteLine(ans);
        }


        static int CalcAokiScore(int[] a, int l, int r)
        {
        ...
        static int CalcTakahashiScore(int[] a, int l, int r)
        {
            if (l > r) { Swap(ref l, ref r); }
