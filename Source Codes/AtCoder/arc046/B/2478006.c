...
./Main.c:399:8: warning: format ‘%llu’ expects argument of type ‘long long unsigned int *’, but argument 2 has type ‘ull * {aka long unsigned int *}’ [-Wformat=]
  scanf("%llu", &n, &m);
        ^
./Main.c:399:8: warning: too many arguments for format [-Wformat-extra-args]
./Main.c:401:8: warning: format ‘%llu’ expects argument of type ‘long long unsigned int *’, but argument 2 has type ‘ull * {aka long unsigned int *}’ [-Wformat=]
  scanf("%llu%llu", &vua, &vub, &vuc, &vud, &vue, &vuf);
        ^
./Main.c:401:8: warning: format ‘%llu’ expects argument of type ‘lo...