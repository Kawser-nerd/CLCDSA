...
./Main.c:556:11: warning: format ‘%llu’ expects argument of type ‘long long unsigned int’, but argument 2 has type ‘ull {aka long unsigned int}’ [-Wformat=]
    printf("0 %llu\n", vua);
           ^
./Main.c: In function ‘main’:
./Main.c:598:8: warning: format ‘%llu’ expects argument of type ‘long long unsigned int *’, but argument 2 has type ‘ull * {aka long unsigned int *}’ [-Wformat=]
  scanf("%llu", &n, &m);
        ^
./Main.c:598:8: warning: too many arguments for format [-Wformat-extra-args]
./Main.c:601:8: warning: format ‘%llu’ expects argument of type ‘l...