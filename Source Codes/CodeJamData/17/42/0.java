    ...
    static class TaskB {
        public void solve(int testNumber, InputReader in, OutputWriter out) {
            Scheduler scheduler = new Scheduler(in, out, () -> new Task() {
                ...
                public void solve() {
                    MiscUtils.decreaseByOne(p, b);
                    ArrayUtils.orderBy(p, b);
                    int[] qty = new IntArray(b).qty(c);
                    int left = ArrayUtils.maxElement(qty);
                    int right = m;
                    while (left < right) {
                    ...
                    minRides = left;
                    qty = new IntArray(p).qty(n);
                    for (int i : qty) {
                        minPromos += Math.max(0, i - minRides);
                    }
                }


                public void write(OutputWriter out, int testNumber) {
                    out.printLine("Case #" + testNumber + ":", minRides, minPromos);
                }
            }, 4);
        }
