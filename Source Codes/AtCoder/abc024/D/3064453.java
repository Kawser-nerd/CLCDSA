...
public class Main {
    ...
    public static void solve() {
        ...
        long C = nl();
        {
            long ru = modDiff(modMul(B, C), modMul(A, C));
            long rd = modSum(modDiff(modMul(A, B), modMul(B, C)), modMul(A, C));
            long r = modDiv(ru, rd);
            System.out.print(r + " ");
        }
        {
            long cu = modDiff(modMul(C, B), modMul(A, B));
            long cd = modSum(modDiff(modMul(A, C), modMul(C, B)), modMul(A, B));
            long c = modDiv(cu, cd);
