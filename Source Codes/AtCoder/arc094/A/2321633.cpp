...
int main() {
    ...
    std::set<std::tuple<int, int, int>> mem;
    ...
    while(!que.empty()) {
        ...
        if(!mem.count(make_tuple(s.a + 1, s.b + 1, s.c))) {
            mem.insert(make_tuple(s.a + 1, s.b + 1, s.c));
            que.push((S){s.a + 1, s.b + 1, s.c, s.cnt + 1});
        }

        if(!mem.count(make_tuple(s.a + 1, s.b, s.c + 1))) {
            mem.insert(make_tuple(s.a + 1, s.b, s.c + 1));
            que.push((S){s.a + 1, s.b, s.c + 1, s.cnt + 1});
        }

        if(!mem.count(make_tuple(s.a, s.b + 1, s.c + 1))) {
            mem.insert(make_tuple(s.a, s.b + 1, s.c + 1));
            que.push((S){s.a, s.b + 1, s.c + 1, s.cnt + 1});
        }

        if(!mem.count(make_tuple(s.a + 2, s.b, s.c))) {
            mem.insert(make_tuple(s.a + 2, s.b, s.c));
            que.push((S){s.a + 2, s.b, s.c, s.cnt + 1});
        }

        if(!mem.count(make_tuple(s.a, s.b + 2, s.c))) {
            mem.insert(make_tuple(s.a, s.b + 2, s.c));
            que.push((S){s.a, s.b + 2, s.c, s.cnt + 1});
        }

        if(!mem.count(make_tuple(s.a, s.b, s.c + 2))) {
            mem.insert(make_tuple(s.a, s.b, s.c + 2));
            que.push((S){s.a, s.b, s.c + 2, s.cnt + 1});
        }
    }
}