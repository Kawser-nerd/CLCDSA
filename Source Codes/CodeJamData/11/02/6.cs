...
namespace CodeJam2011Qual
{
    ...
    public class RunMain
    {
        static void Main( string[ ] args )
        {
            ...
            //new CodeJam2011Qual.B( ).Solve( dir + "BSample.txt", dir + "out.txt" );
            //new CodeJam2011Qual.B( ).Solve( dir + "B-small-attempt0.in", dir + "out.txt" );
            new CodeJam2011Qual.B( ).Solve( dir + "B-large.in", dir + "out.txt" );
        }
    }
}
