...
//	char large_outputfilename[100]; sprintf(large_outputfilename,"D-large%d.out",d_testcase); freopen("D-large.in","r",stdin);freopen(large_outputfilename,"w",stdout);
	int testcase;
	scanf("%d",&testcase);
