main(a,b){scanf("%d%d",&a,&b);printf("%d",b>a/2?a-b:b-1);} ./Main.c:1:1: warning: return type defaults to ‘int’ [-Wimplicit-int]
 main(a,b){scanf("%d%d",&a,&b);printf("%d",b>a/2?a-b:b-1);}
 ^
