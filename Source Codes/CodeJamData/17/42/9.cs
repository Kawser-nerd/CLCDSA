...
namespace jam
{
    ...
    public static class JamUtils
    {
        ...
        public static IEnumerable<TestCase> SplitCases(IList<string> lines, int linesPerCase, bool skipHeader = false)
        {
            return SplitCases(lines, (s) => linesPerCase, skipHeader);
        }
