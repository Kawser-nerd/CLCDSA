...
public class Program
{
    ...
    public class PersistentPartialUnionFind
    {
        ...
        public bool Unite(int a, int b)
        {
            ...
            if (NumE[a] == E[a].Length)
            {
                var next = new Edge[NumE[a] * 2];
                Array.Copy(E[a], next, E[a].Length);
                E[a] = next;
            }
            E[a][NumE[a]++] = new Edge(CurrentTime, Size[a] + Size[b]);
            Size[a] += Size[b];
            Parent[b] = a;
