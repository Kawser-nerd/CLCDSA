        ...
        private void Solve()
        {
            ...
            switch (N)
            {
                case 1:
                    ...
                    return;
                case 2:
                    Console.WriteLine(Max(t[0], t[1]));
                    return;
                case 3:
                    //1+2, 3
                    list.Add(Max(t[0] + t[1], t[2]));
                    list.Add(Max(t[0] + t[2], t[1]));
                    list.Add(Max(t[1] + t[2], t[0]));

                    break;
                case 4:
                    /* 1 + 3 */

                    list.Add(Max(t[0], t[1] + t[2] + t[3]));
                    list.Add(Max(t[1], t[0] + t[2] + t[3]));
                    list.Add(Max(t[2], t[1] + t[0] + t[3]));
                    list.Add(Max(t[3], t[1] + t[2] + t[0]));

                    /* 2 + 2 */
                    list.Add(Max(t[0] + t[1], t[2] + t[3]));
                    list.Add(Max(t[0] + t[2], t[1] + t[3]));
                    list.Add(Max(t[0] + t[3], t[1] + t[2]));
                    break;
            }
