...
./Main.c:77:9: warning: format ‘%ld’ expects argument of type ‘long int’, but argument 2 has type ‘long long int’ [-Wformat=]
  printf("%ld\n", ans);
         ^
...
./Main.c:37:23: warning: ignoring return value of ‘scanf’, declared with att...