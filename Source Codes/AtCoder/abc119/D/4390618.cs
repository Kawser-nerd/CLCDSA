    ...
    class Program
    {
        ...
        void Solve()
        {
            ...
            for (int i = 1; i <= q; i++)
            {
                ...
                distanceList.Add(GetDistance2(s, t, start));
                distanceList.Add(GetDistance2(t, s, start));

                answer.Append(distanceList.Min());
                answer.AppendLine();
        ...
        long GetDistance2(long[] array1, long[] array2, long start)
        {
        ...
        int GetIndex(long[] array, long value)
        {
            ...
            while (0 <= index && index < array.Length - 1)
            {
