...
./Main.c:387:10: warning: format ‘%lld’ expects argument of type ‘long long int’, but argument 2 has type ‘sll {aka long int}’ [-Wformat=]
   printf("%lld\n", x);
          ^
...
./Main.c:440:9: warning: format ‘%lld’ expects argument of type ‘long long int *’, but arg...