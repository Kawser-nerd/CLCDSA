...
./Main.c:436:10: warning: format ‘%llu’ expects argument of type ‘long long unsigned int’, but argument 2 has type ‘ull {aka long unsigned int}’ [-Wformat=]
   printf("%llu%c", a[i], ((i < n - 1) ? ' ' : '\n'));
          ^
./Main.c:439:10: warning: format ‘%llu’ expects argument of type ‘long long unsigned int’, but argument 2 has type ‘ull {aka long unsigned int}’ [-Wformat=]
   printf("%llu%c", b[i], ((i < n - 1) ? ' ' : '\n'));
          ^
./Main.c: In function ‘main’:
./Main.c:467:8: warning: format ‘%llu’ expects argument of type ‘long long unsigned int *’,...