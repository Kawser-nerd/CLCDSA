main(a,b){scanf("%d%d",&a,&b);printf("%d",b%a?b/a+1:b/a);} ./Main.c:1:1: warning: return type defaults to ‘int’ [-Wimplicit-int]
 main(a,b){scanf("%d%d",&a,&b);printf("%d",b%a?b/a+1:b/a);}
 ^
