...
./Main.c:1:19: warning: format ‘%c’ expects argument of type ‘char *’, but argument 3 has type ‘int *’ [-Wformat=]
 main(a,b,c){scanf("%d %c%d",&a,&b,&c);printf("%d",b&2?a+c:a-c);}
                   ^
./Main.c:1:39: warning: implicit declaration of function ‘printf’ [-Wimplicit-function-declaration]...