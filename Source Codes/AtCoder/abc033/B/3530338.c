...
./Main.c:92:9: warning: format ‘%s’ expects argument of type ‘char *’, but argument 2 has type ‘char (*)[21]’ [-Wformat=]
   scanf("%s%d", &S[n], &P[n]);
         ^
...
./Main.c:39:23: warning: ignoring return value of ‘scanf’, declared with...